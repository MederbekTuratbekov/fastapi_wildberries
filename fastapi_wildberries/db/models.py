...
class UserProfile(Base):
    ...
    user_cart: Mapped[Optional['Cart']] = relationship('Cart', back_populates='user', cascade='all, delete-orphan', uselist=False)
    user_favorite: Mapped[Optional['Favorite']] = relationship('Favorite', back_populates='user', cascade='all, delete-orphan', uselist=False)

    def __str__(self):
        return f'{self.lastname}, {self.first_name}'
...
class Favorite(Base):
    ...
    favorite_items: Mapped[List['FavoriteItem']] = relationship('FavoriteItem', back_populates='favorite', cascade='all, delete-orphan')
